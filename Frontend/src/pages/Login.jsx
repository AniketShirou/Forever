  ...
  return (
    <form onSubmit={onSubmit} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      <div className='inline-flex items-center gap-2 mb-2 mt-10'>
       ...
       <div className='w-full flex justify-between text-sm text-gray-600 mt-[-8px]'>
       ...
       <button className=' bg-black text-white px-8 py-2 mt-4 cursor-pointer hover:bg-gray-800 transition-all'>{currentState}</button>
    </form>
  )
}
