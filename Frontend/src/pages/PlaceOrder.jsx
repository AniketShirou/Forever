...
const PlaceOrder = () => {
  ...
  const [payementMethod, setPaymentMethod] = useState('cod');
        ...
        <div className='mt-12'>
           ...
           <div className='flex gap-3 flex-col lg:flex-row'>
               <div onClick={() => setPaymentMethod('stripe')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                   <p className={`min-w-3.5 h-3.5 border rounded-full ${payementMethod === 'stripe' ? 'bg-green-200' : ''}`}></p>
                ...
                <div onClick={() => setPaymentMethod('razorpay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                   <p className={`min-w-3.5 h-3.5 border rounded-full ${payementMethod === 'razorpay' ? 'bg-green-200' : ''}`}></p>
                ...
                <div onClick={() => setPaymentMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                   <p className={`min-w-3.5 h-3.5 border rounded-full ${payementMethod === 'cod' ? 'bg-green-200' : ''}`}></p>
