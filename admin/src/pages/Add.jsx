  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-4'>
      ...
      <div className='flex gap-2 items-center mt-2'>
        ...
        <label className='ml-2 cursor-pointer' htmlFor='bestseller'>Mark as Bestseller</label>
      </div>

      <button className='bg-black text-white px-6 py-2 rounded mt-4 cursor-pointer' type='submit'>Add Product</button>
